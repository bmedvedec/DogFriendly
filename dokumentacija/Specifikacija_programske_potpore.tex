\chapter{Specifikacija programske potpore}
	...
	\section{Funkcionalni zahtjevi}
			...
			\begin{packed_enum}
				...
				\item  \underbar{Klijent(registirani korisnik) može:}
				...
				\subsubsection{Opis obrazaca uporabe}
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Prikazuje se poruka o uspještnoj registraciji
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_item}
							...
							\end{packed_enum}
							\item[2.b] Odabir već zauzetog korisničkog imena i/ili e-maila, unos korisničkog podatka u nedozvoljenom formatu ili pružanje neispravnog e-maila, ne zadovoljavanje kompleksnosti lozinke, promjenjena lozinka je jednaka trenutnoj
							\item[] \begin{packed_enum}
								
								\item Sustav obajveštava korisnika o neuspjelom upisu i vraća ga na stranicu za promjenu podataka
					...
					\begin{packed_item}
						...
						\item \textbf{Glavni sudionik: }Klijent
						\item  \textbf{Cilj:} Ocjeniti je li lokacija prikladna za pse ili nije
						\item  \textbf{Sudionici:} Baza podataka
						...
						\item[] \begin{packed_enum}
							...
							\item Korisnik odabire opciju "Ocjeni lokaciju"
