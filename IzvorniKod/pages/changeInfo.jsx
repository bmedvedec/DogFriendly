...
export default function UserInfo() {
	...
	useEffect(() => {
		...
		if (!companyInfo) {
			if (username && !usernameExists && !loading) {
	...
	return (
		<div className={styles.background}>
				...
				{authUser ? (
					<div className={styles.right}>
						<div className={styles.accountInfo}>
							<img
								src="/corgiHeader.png"
								alt="corgi header Icon for user"
							/>
							<Link href="/userinfo">Profile</Link>
						</div>
						<Link href="/">
							<span onClick={firebaseSignOut}>
								<i>Sign out</i>
							</span>
						</Link>
					</div>
			...
			<div className={styles.body}>
				...
				>
					{userInfo && (
						<h1 className={styles.changeTitle}>
							Change username:{" "}
						</h1>
					)}
					...
					{companyInfo && (
						<h1 className={styles.changeTitle}>Company name: </h1>
					)}
